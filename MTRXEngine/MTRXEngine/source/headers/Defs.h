...
{	
	...
	struct Transform
	{
		...
		Transform(const glm::vec3& position, const glm::quat& quaternion, const glm::vec3& scale) : position(position), 
			orientation(quaternion), scale(scale) 
		{}
	};
